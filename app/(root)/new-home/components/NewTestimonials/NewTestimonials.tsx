...
const testimonials = [
  {
    ...
    quote: 'Ирина создала невероятную атмосферу на нашей свадебной фотосессии. Каждое фото передает искренние эмоции и любовь. Мы в восторге от результата!',
    rating: 5
  },
  {
    id: 2,
    ...
    quote: 'Профессионализм и внимание к деталям - это про Ирину. Она смогла поймать самые тёплые моменты нашей семейной съёмки. Фотографии получились живыми и естественными.',
    rating: 5
  },
  {
    id: 3,
    ...
    quote: 'Это была моя первая профессиональная фотосессия, и я очень волновалась. Но Ирина помогла мне раскрепоститься, и результат превзошел все ожидания!',
    rating: 5
  }
];
